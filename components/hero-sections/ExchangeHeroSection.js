...
export default function ExchangeHeroSection({ listRef }) {
  return (
    <section className=" bg-black dark:bg-transparent text-gray-300 px-10 sm:px-0 sm:py-20 dark:border-b dark:border-gray-200">
      <div className="container mx-auto flex flex-col items-center md:flex md:flex-row md:items-stretch md:justify-around">
